...
import styles from './HomeSchoolImages.module.scss'

type Props = ComponentProps<'div'> & {
  data: Queries.HomeSchoolImagesFragment[] | null | undefined
}

export const HomeSchoolImages = ({ data, ...props }: Props) => {
  ...
  const getImage = useCallback(
    (image: any) => {
      if (
        ...
        return { image: image.vertical, ar: 1 / 1 }
      }
    },
    [windowDimensions]
  )
